...
public class PictureTester {
	...
	private static void testKeepOnlyBlue() {
		...
		//Creates two different Picture Objects, using an item from the Picture class
		Picture myLogo = new Picture("scenic.jpg");// You would change the var name and file name to your picture when you are testing your image.
		//Code below is necessary to make your image smaller if you took it from your camera.
    Picture sLogo = myLogo.scale(0.2,0.2);// scales the size down if you need to resize. (0.5,0.5) reduces the size by half (scaled beach)
    sLogo.write("logoNew.png"); //Writes the new scaled image to your folder
  
  
		sLogo.explore();// shows the picture in a window
		sLogo.keepOnlyBlue();// Calls your keep only blue method //GO TO YOUR Picture.java and find your KeepOnlyBlue Method
		sLogo.explore();//shows a new picture with only blue hues
    ...
    sLogo.write("logoNew.png"); //Writes the new scaled image to your folder
		...
		sLogo.explore();// shows the picture in a window
		sLogo.keepOnlyGreen();// Calls your keep only blue method //GO TO YOUR Picture.java and find your KeepOnlyBlue Method
		sLogo.explore();//shows a new picture with only blue hues
	...
	private static void testKeepOnlyRed() {
		...
		//Creates two different Picture Objects, using an item from the Picture class
		Picture myLogo = new Picture("selfie.jpg");// You would change the var name and file name to your picture when you are testing your image.
		//Code below is necessary to make your image smaller if you took it from your camera.
    Picture sLogo = myLogo.scale(1,1);// scales the size down if you need to resize. (0.5,0.5) reduces the size by half (scaled beach)
    sLogo.write("logoNew.png"); //Writes the new scaled image to your folder
  
  
		sLogo.explore();// shows the picture in a window
		sLogo.keepOnlyRed();// Calls your keep only blue method //GO TO YOUR Picture.java and find your KeepOnlyBlue Method
		sLogo.explore();//shows a new picture with only blue hues
	...
	private static void testChromakey() {
		Picture background = new Picture("temple.jpg");
		Picture foreground = new Picture("spidey.jpg");
		background.explore();
		background.chromaKey(foreground);
		background.explore();
	}
